  ...
  return (
    <>
      <ScrollView
        ...
        accessibilityHint="Form to register a new account">
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.mainContent}>
              ...
              <InputBox
                ...
                value={firstName}
                icon={<UserIcon />}
                accessibilityLabel="First Name Editbox"
                accessibilityHint="Enter your first name here"
              />
              <InputBox
                title="Last Name"
                ...
                value={lastName}
                icon={<UserIcon />}
                accessibilityLabel="Last Name Editbox"
                accessibilityHint="Enter your last name here"
              />
              <InputBox
                title="Email ID"
                ...
                value={email}
                icon={<Mail />}
                accessibilityLabel="Email ID Editbox"
              ...
              {checkboxVal === 1 && (
                <>
                  <InputBox
                    ...
                    value={udidNo}
                    icon={<DocIcon />}
                    accessibilityLabel="UDID Number Editbox"
                    accessibilityHint="Enter your Unique Disability ID number here"
                  />
                  <View style={styles.mainContainer1}>
                    <Text
                      style={styles.headingText1}
                      accessible={true}
                      accessibilityLabel="UDID Document section">
                      UDID Doc
                    </Text>
                    <View style={styles.mainBox}>
                      ...
                      <TouchableOpacity
                        onPress={checkPermissionAndPick}
                        style={styles.inputContainer}
                        accessible={true}
                        accessibilityLabel="Upload UDID document"
                        accessibilityHint="Tap to select your UDID document file"
              ...
              {checkboxVal === 2 && (
                <>
                  <InputBox
                    ...
                    accessibilityHint="Enter your AADHAAR identification number"
                  />
                  <View style={styles.mainContainer1}>
                    <Text
                      style={styles.headingText1}
                      accessible={true}
                      accessibilityLabel="AADHAAR Document section">
                      AADHAAR Doc
                    </Text>
                    <View style={styles.mainBox}>
                      <View style={styles.iconContainer}>
                      ...
                      <TouchableOpacity
                        ...
                        accessibilityHint="Tap to select your AADHAAR document file"
                        accessibilityRole="button">
                        <Text> -- Choose --</Text>
                      </TouchableOpacity>
                    </View>
